...
void CPhrasesGenerator::GeneratePhrasesFromParsedFiles()
{
    ...
    {
        std::string languageCode = m_LanguageCodeNames[u16_to_UTF8(language)];
        ...
        if (language != u"English")
        {
            ...
            {
                std::cout << "Language \"" << u16_to_UTF8(language) << "\" has no code" << std::endl;
                continue;
            }
        ...
        phrasesFile << "// "+ u16_to_UTF8(language) + " phrases file\n\
        ...
        {
            phrasesFile << "\t\"" << u16_to_UTF8(key) << "\"\n\
                            \t{\n\
                            \t\t\"" << languageCode << "\"\t\t\"" << u16_to_UTF8(value) << "\"\n\
                            \t}\n\
                            \n";
        }
